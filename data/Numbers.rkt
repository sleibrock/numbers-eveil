...
(define Numbers-list 
  (map
   ...
   `(; Numeron Gate / Don Thousand monsters
     ...
     ("Number 16: Shock Master" 4 16 light fairy 10) ; banned
     ...
     ;("Number 42: Galaxy Tomahawk" 7 42 wind machine 10) ; banned
     ...
     ;("Number 86: Heroic Champion - Rhongomyniad" 4 86 dark warrior 10) ; banned
     ("Number 87: Queen of the Night" 8 87 water plant 3)
     ("Number 88: Gimmick Puppet of Leo" 8 88 dark machine 4)
     ;("Number 89: Diablosis the Mind Hacker" 7 89 dark psychic 10) ; banned
     ...
     ;("Number 95: Galaxy-Eyes Dark Matter Dragon" 9 95 dark dragon 10) ; banned
     ...
     ("Number 101: Silent Honor ARK" 4 107 water aqua 4)
     ...
     ;("Number C1000: Numeronious" 12 1000 light fiend 5) ; not possible
     ;("Number iC1000: Numerounius Numerounia" 13 1000 light fiend 5) ; not possible
     ; Shining Numbers
     ;("Number S0: Utopic Zexal" 1 0 light warrior 10) ; banned
